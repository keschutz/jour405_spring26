...
The two biggest spikes (anomalies), one high spike and one low spike, happened in late 2021. I don't know if that necessarily warrants a story, because the dates weren't exactly back to back, but I would definitely want to take steps to look into the 58 accidents that took place on Oct. 29, 2021, to see if there was any kind of event that may have caused such a high number in one day. I'd also be curious to see if anything happened on Nov. 30, 2021, when there was only one accident, to see if something may have discouraged people from driving that day, or if something else may have had an influence on the number of accidents. Weather- or crime-realted events, for example.

It also appears that, once accident numbers started rising again following the large dip in 2020, which I can assume was because of the pandemic, accident numbers seemed to increase for the next two years, rising even higher than pre-pandemic numbers, with minimal other drops. I wonder if there is a pandemic-related reason for this increase, or some other reason.
...
Weekend days, including Fridays, have the highest averages of accidents, likely because more people are on the roads for activities outside of the regular work day. People may be more likely to be drinking, or driving in unfamiliar areas, both of which could result in more accidents. 

Weekdays have lower averages, likely because people are in more of a regular, comfortable routine during the week, making it less likely that something would go awry.
...
According to the National Weather Service, there was severe flooding and rain in the Washington, D.C., area on Oct. 29, 2021, which extended into the PG county area. Rain and stormy conditions endured for most of the day, according to Weather Spark. This information could likely be incorporated into the lead and earlier grafs in a story, initially dropping something about severe weather conditions and the number of accidents that day in the lede and following it up with specifics about the weather conditions in the next few grafs.
...
The z-scores for the extreme days in the context of the total data were higher than those for the extreme days in the context of the DOW categorization. the DOW approach allows us to confirm that an extreme day is still unusual when you compare it to other of its kind, whereas if you were to rely solely on the total data approach, there is a chance that an extreme day with a high z-score could actually be less abnormal in the context of other same days. 
...
The average number of incidents per month generally increases as the year progresses, with January sitting at the lowest average and December at the second-to-highest, topped only by October. Two reasons that I think could cause this is that there is more travel during the holiday months, with people going to visit family and friends, which could mean more people on the road and more accidents as we reach the end of the year. The sun setting earlier could also be a factor, increasing the liklihood of people traveling in the dark, which can also cause more accidents.
...
The days included in this list with positive z-scores (+3) were all Fridays and Saturdays.
...
I would be interested in writing a story about the causes for the dates with unusually high z-scores that also took place on Fridays or Saturdays. What time of day? Any DUIs? Were drivers local or from out of town? Or are there other underlying reasons and the fact that there are so many Fridays and Saturdays in the mix is just a coincidece? I would definitely have to look at accident reports and police records. I would try to talk to Prince George's County police representatives about how they think the day of the week could impact accident numbers. If I found that there were common reasons for accidents on Fridays and Saturdays, I would try to talk to related experts. For example, if DUIs were commonly reported in those extreme cases, I would find a professional to talk about DUI numbers, how they change based on the day of the week and the importance of staying off the road while under the influence.

HL: Weekends see unusually high accident numbers in Prince George's County

Dates on Fridays and Saturdays held the top eight slots for highest number of accidents in Prince George's County between February 2017 and April 2025.
