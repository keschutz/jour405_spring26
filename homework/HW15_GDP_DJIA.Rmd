...
GDP_DJIA |> 
  ...
  ggtitle("Relationship between Dow Jones Industrial Average and Gross Domestic Product")
```
...
There is a very strong correlation between the DJIA and GDP. The correlation coefficient is remarkably high at 0.9531058, and there is a clear positive relationship on the scatterplot between the two variables. However, it is still possible that there are other variables involved. 
