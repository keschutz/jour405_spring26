...
I think it could be argued that this data set is normally distributed. It's definitely not perfectly normally distributed, but the curve has a normal-ish shape to it. At least two thirds of the data are within one standard deviation of the mean, falling within the range 8.4 to 16.96 thefts. 
